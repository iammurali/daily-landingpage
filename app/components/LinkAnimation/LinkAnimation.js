...
const ThreeColumnLayout = () => {
  ...
  const seq = [
    ...
    [".exchangeArrow", { x: [-30, 35], opacity: [1, 1] }, { duration: 0.5, delay: 0.5, ease: "easeInOut" }],
    [".dailyRectangle", { backgroundColor: ["#ffffff", "#4175FF", "#ffffff"] }, { duration: 2, delay: 0.5 }],
    [".vendorArrow", { x: [-75, 10], opacity: [1, 1] }, { duration: 0.5, delay: 0.5, ease: "easeInOut" }],
    [".vendorCircle", { scaleX: 1.2, scaleY: 1.2, opacity: [0.5, 1] }, { duration: 0.5, delay: 0.5 }],

    [".vendorCircle", { scaleX: [1.2, 1], scaleY: [1.2, 1], opacity: [1, 0.5] }, { duration: 0.1, delay: 1 }],
    [".exchangeArrow", { opacity: [0, 0], x: [35, -30], }, { duration: 0.5, delay: 0.5 }],
    // [".dailyRectangle", { rotate: -360 }, { duration: 0.1 }],
    [".vendorArrow", { opacity: [0, 0], x: [10, -75] }, { duration: 0.1, delay: 0.5 }],
    ...
    [".exchangeArrow", { x: [-30, 35], opacity: [1, 1] }, { duration: 0.5, delay: 0.5, ease: "easeInOut" }],
    [".dailyRectangle", { backgroundColor: ["#ffffff", "#4175FF", "#ffffff"] }, { duration: 2, delay: 0.5 }],
    [".vendorArrow", { x: [-75, 10], opacity: [1, 1] }, { duration: 0.5, delay: 0.5, ease: "linear" }],
    [".secondVendorCircle", { scaleX: 1.2, scaleY: 1.2, opacity: [0.5, 1] }, { duration: 0.5, delay: 0.5 }],
  ...
  useEffect(() => {
    animate(seq, { duration: 10, repeat: Infinity, repeatType: "loop", });
  },)
